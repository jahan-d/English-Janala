...
const displayLevelWord = (words) => {
    ...
    words.forEach(word => {
        ...
        <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
            ...
            <div class="font-medium font-bangla">${word.meaning? word.meaning:"not found"} / ${word.pronunciation?word.pronunciation: "not found"}</div>
            <div class="flex justify-between items-center">
                <button class="btn bg-[#1A91FF10]mhover:bg-[#1A91FF80]"><i class="fa-solid fa-circle-info"></i></button>
